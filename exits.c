...
/**
 * __strncpy - Copies a string with a maximum length.
 ...
 *
 * This function copies up to 'max_length' characters from 'source' to 'destination'.
 * If 'max_length' is greater than the length of 'source', it copies the entire string.
 ...
 *
 * This function concatenates up to 'max_length' bytes from 'source' to the end of 'destination'.
 * If 'max_length' is greater than the available space in 'destination', it appends as much as possible.
 * Returns a pointer to 'destination'.
 */
 ...
 *
 * This function searches for 'character' in 'string'.
 * If found, it returns a pointer to the first occurrence of 'character' in 'string'.
